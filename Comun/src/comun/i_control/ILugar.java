...
public interface ILugar extends Remote{

	public Long agregarLugar(LugarDTO objeto)throws Exception;
	...
	public Vector<LugarDTO> obtenerLugares(String filtro,String orden, String agrupar)throws Exception;
