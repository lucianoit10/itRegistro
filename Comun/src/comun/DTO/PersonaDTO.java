...
public class PersonaDTO  implements Serializable{
	...
	public PersonaDTO(String nombre, String apellido,String registro, String dni_cuil_cuit, String tel_contacto,String direccion) {
		this.nombre = nombre;
	...
	public String toString() {
		return "PersonaDTO [id=" + id + ", nombre=" + nombre + ", apellido="
